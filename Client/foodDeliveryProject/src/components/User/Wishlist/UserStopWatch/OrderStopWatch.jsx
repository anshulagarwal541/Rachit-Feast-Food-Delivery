...
const OrderCountDown = () => {
  ...
  const startCountDown = useCallback(() => {
    ...
    // );
    const countDownDate = new Date('2024-08-30T14:30:00');
    setInterval(() => {
  ...
  return (
    <div className="">
      <div className="flex flex-col items-center justify-center w-full h-full gap-8 sm:gap-16 text-black mt-15">
        <div className="flex justify-center gap-3 sm:gap-8">
          <div className="flex flex-col gap-5 relative">
            <div className="h-16 w-16 sm:w-32 sm:h-32 lg:w-40 lg:h-40 flex justify-between items-center bg-secondary rounded-lg">
              ...
              <span className="lg:text-7xl sm:text-6xl text-3xl font-semibold text-white bg-indigo-950 p-5 rounded-2xl">
                {countDownTime?.days}
              </span>
