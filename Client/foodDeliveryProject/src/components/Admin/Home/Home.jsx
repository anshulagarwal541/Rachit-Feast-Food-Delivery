    ...
    return (
        <div className='bg-indigo-50 min-h-screen flex flex-col justify-center lg:flex-row gap-5 items-center px-4 lg:px-8 py-8'>
            ...
            <div className='flex flex-wrap lg:flex-col gap-4 justify-center items-center w-full lg:w-auto'>
                ...
                <div className='flex flex-col gap-2 justify-center items-center bg-white rounded-2xl px-6 py-3 w-full md:w-[10rem] md:h-[10rem] lg:w-[15rem] lg:h-[10rem]'>
                    <p className='font-bold text-center text-lg lg:text-xl w-fit'>Total Users</p>
                    <p className=' w-fit'>654</p>
                    <BarChartIcon />
                </div>
                <div className='flex flex-col gap-2 justify-center items-center bg-white rounded-2xl px-6 py-3 w-full md:w-[10rem] lg:w-[15rem] md:h-[10rem] lg:h-[10rem]'>
                    <p className='font-bold text-center text-lg lg:text-xl w-fit'>Total Vendors</p>
                    <p className=' w-fit'>654</p>
                    <BarChartIcon />
                </div>
                <div className='flex flex-col gap-2 justify-center items-center bg-white rounded-2xl px-6 py-3 w-full md:w-[10rem] lg:w-[15rem] md:h-[10rem] lg:h-[10rem]'>
                    <p className=' w-fit text-center font-bold text-lg lg:text-xl'>Total Restaurants</p>
                    <p className=' w-fit'>654</p>
                    <BarChartIcon />
                </div>
                <div className='flex flex-col gap-2 justify-center items-center bg-white rounded-2xl px-6 py-3 w-full md:w-[10rem] lg:w-[15rem] md:h-[10rem] lg:h-[10rem]'>
